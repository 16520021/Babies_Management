...
Public Class TreBUS
    ...
    Public Sub New()
        treDAL = New TreDAL()
    End Sub
    Public Function isValid_Name(tre As TreDTO) As Boolean
        If (tre.TenTre1.Length <= 5 And tre.TenTre1.Length >= 0) Then
            Return False
        End If
        Return True
    End Function
    Public Function isValid_Hname(tre As TreDTO) As Boolean
    ...
    Public Function nxtMaTre() As Integer
        ...
        Return last
    End Function
    Public Function isValid_Phone(tre As TreDTO) As Boolean
